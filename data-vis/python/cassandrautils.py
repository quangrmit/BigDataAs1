...
AIR_TABLE = os.environ.get("AIR_TABLE") if os.environ.get("AIR_TABLE") else 'airdata'
...
def getDF(source_table):
    ...
    if source_table not in (WEATHER_TABLE, TWITTER_TABLE, AIR_TABLE):
        return None
